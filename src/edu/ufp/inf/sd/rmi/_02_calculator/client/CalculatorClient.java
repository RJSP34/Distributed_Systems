...
public class CalculatorClient {
    ...
    private void playService() {
        try {
            ...
            Logger.getLogger (String.valueOf(calculatorRI.add(1,2)));
       ...
       ArrayList<Double> list=new ArrayList<Double>();
            ...
            list.add(2.0);
            list.add(2.0);
            Logger.getLogger (String.valueOf(calculatorRI.add(list)));
            Logger.getLogger (String.valueOf(calculatorRI.div(5,2)));
            Logger.getLogger (String.valueOf(calculatorRI.sub(3,2)));
            Logger.getLogger (String.valueOf(calculatorRI.mult(list)));
            System.out.println(calculatorRI.mult(list));
