...
public class DibLibServer {
    ...
    public static void main(String[] args) throws RemoteException {
        if (args != null && args.length < 3) {
            ...
            //1. ============ Create Servant ============
           DibLibServer hws = new DibLibServer(args);
     ...
     * @param args
     */
    public DibLibServer(String args[]) {
        try {
            //============ List and Set args ============
    ...
    private void rebindService() {
        try {
            ...
            if (registry != null) {
                //============ Create Servant ============
                DibLibFactoryRI= new DibLibFactoryImpl();
                ...
                registry.rebind(serviceUrl,  DibLibFactoryRI);
